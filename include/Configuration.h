...
public:
    ...
    float getMctsSecondsPerMove() const                             { return m_mctsSecondsPerMove; }
...
private:
    ...
    Configuration(
        ...
        m_mctsSecondsPerMove(mctsSecondsPerMove),
        m_roomId(roomId),
        m_selfId(selfId),
        m_otherId(otherId),
